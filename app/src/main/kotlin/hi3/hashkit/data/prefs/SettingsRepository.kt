...
data class AppSettings(
    ...
    /** Wall / TV mode: draw a last-1h hashrate sparkline on each tile. */
    val wallShowTrend: Boolean = true,
...
class SettingsRepository @Inject constructor(
    ...
    private object Keys {
        ...
        val wallShowTrend = booleanPreferencesKey("wall_show_trend")
    ...
    private fun buildSettings(p: androidx.datastore.preferences.core.Preferences): AppSettings =
        AppSettings(
            ...
            wallShowTrend = p[Keys.wallShowTrend] ?: true,
    ...
    suspend fun setWallShowTrend(value: Boolean) = edit { it[Keys.wallShowTrend] = value }
