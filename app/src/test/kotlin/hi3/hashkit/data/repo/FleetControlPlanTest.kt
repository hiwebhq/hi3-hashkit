...
private object FailingMinerDao : hi3.hashkit.data.db.MinerDao {
    ...
    override suspend fun updatePlug(id: Long, type: String?, host: String?, onUrl: String?, offUrl: String?, cutoffC: Double?) = throw UnsupportedOperationException()
    ...
    override suspend fun updateCredential(id: Long, enc: String?) = throw UnsupportedOperationException()
    override suspend fun updatePurchasePrice(id: Long, price: Double?) = throw UnsupportedOperationException()
...
private object FailingTelemetryDao : hi3.hashkit.data.db.TelemetryDao {
    ...
    override suspend fun settingsPeriods(minerId: Long, sinceEpochMs: Long, minSamples: Int) =
